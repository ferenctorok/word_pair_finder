...
words_dir_short = os.path.join('..', 'words', str(args.length))
words_dir_long = os.path.join('..', 'words', str(length + 1))
output_dir = os.path.join('output', 'extra_letter_at_end')
...
for file_name in listdir(words_dir_short):
    ...
    word_list_long_shortened = get_shortened_list(word_list_long)
